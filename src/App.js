		...
		<div className="App">
			...
			<div className="content">
				<div className="container">
					...
					<div className="cards">
						<div className="card">
							<img className="favorite-icon" src="/img/heart.svg" alt="addtofavorite" />
							<div className="card-inner">
								<img width={133} height={112} src="/img/sneakers/image 5-1.jpg" alt="yeezy-item" />
					...
					<div className="card-side-items">
						<div className="card-side-item">
							<div className="card-side-item-inner">
								<img width={70} height={70} src="/img/sneakers/image 5-1.jpg" alt="yeezy-item" />
